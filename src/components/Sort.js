...
const Sort = () => {
  ...
  const{filtered_products,grid_view,setGridView,setListView,updateSort,sort}=useFilterContext();
  ...
  <form>
    ...
    <select id='sort'name='sort' className='sort-input' value={sort} onChange={updateSort}>
